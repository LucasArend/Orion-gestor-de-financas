...
export default function Goals() {
  ...
  return (
    <div className="space-y-6 rounded-lg bg-white p-8">
      ...
      {/* 3. Tabela de Metas */}
      {loading ? (
        <p className="py-10 text-center text-gray-500">Carregando metas...</p>
      ) : filteredMetas.length === 0 ? (
        <div className="rounded-lg border border-gray-200 bg-gray-50 py-10 text-center">
          <p className="mb-2 font-semibold text-gray-700 text-xl">
            Nenhuma meta encontrada
          </p>
          <p className="text-gray-500">
            Comece a planejar seu futuro! Clique em{' '}
            <strong>Adicionar Meta</strong> para criar seu primeiro objetivo.
          </p>
        </div>
      ) : (
        <GoalsTable
