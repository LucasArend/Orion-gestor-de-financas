        ...
        <div className="flex w-full flex-col space-y-2">
          ...
          >
            <div className="relative">
              {/* Botão principal */}
              <ListboxButton className="flex w-full items-center justify-between rounded-lg border border-gray-300 bg-white p-3 text-left focus:border-indigo-600 focus:outline-none focus:ring-2 focus:ring-blue-200">
                <span>
